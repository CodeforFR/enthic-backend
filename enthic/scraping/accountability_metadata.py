    ...
    def compare(self, metadata_from_bdd):
        ...
        if self.accountability in ["B"]:
            print(
                "le nouveau bilan",
                self,
                "est un bilan de type de comptabilité qu'on s'en fout pour l'instant",
            )
        ...
        if self.date_cloture_exercice != metadata_from_bdd[3]:
            ...
            if (
                ...
                print(
                    "New metadata",
                    self,
                    "prolonge, vers le passé, le metadata déjà en base",
                    metadata_from_bdd,
                    "pour un changement de date d'année fiscale",
                )
            ...
            if (
                ...
                print(
                    "New metadata",
                    self,
                    "prolonge le metadata déjà en base",
                    metadata_from_bdd,
                    "après un changement de date d'année fiscale, ou un début d'activité",
                )
                return MetadataCase.COMPLEMENTARY
            ...
            if (
                ...
                if better_code_motif and less_confidential:
                    print(
                        "New metadata",
                        self,
                        "chevauche la période du metadata déjà en base",
                        metadata_from_bdd,
        ...
        if better_code_motif and less_confidential:
            print(
                "le nouveau bilan",
                self,
                "couvre la même période que le metadata en base",
                metadata_from_bdd,
